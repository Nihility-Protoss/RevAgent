"""Dynamic workflow orchestrator: setup HITL -> Phase 0 -> Phase 1 -> Phase 2 -> HITL -> Phase 3 -> Phase 4."""
import json
import os
...
from tools.state_utils import coerce_state_dict, extract_arch_detection
...
async def analysis_orchestrator(ctx: Any, node_input: Any | None = None) -> Any:
    ...
    if not ctx.state.get("active_guides_resolved"):
        resolve_active_guides(
            ...
            arch_detection=extract_arch_detection(ctx.state.get("string_analysis")),
        )
